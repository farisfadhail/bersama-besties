			...
			<div className="container px-4 md:px-6" data-aos="fade-up">
				<div className="flex flex-col items-center justify-center space-y-4 text-center">
					<div className="space-y-2">
						...
						<p data-aos="fade-up" data-aos-duration="700" className="max-w-[980px] text-justify md:text-center mx-auto text-muted-foreground md:text-sm/relaxed lg:text-xs/relaxed xl:text-base/relaxed">
